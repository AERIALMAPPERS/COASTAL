    ...
    const data = {
        "Palghar": {
            "Talasari": {
                "Zai": {
                    ...
                    "VillageMapURL":"./data/kmz/palghar  kml.kml" 
                }
            },
            "Dahanu": {
                "Bordi": {
                    ...
                    "dtmURL": "./data/kmz/JALANA.kml", // Add DTM URL
                    // "VillageMapURL":"./data/kmz/bordi_index.kml",
                    "VillageMapURL":"./data/G.Village Map/Palghar/DAHANU/BORDI/BORDI.dwg",
                    "VillageMapKmlURL":"./data/kmz/bordi_index.kml"
                },
                "Vikasnager": {
                    "chainageURL": "./data/kmz/JALANA.kml",
                    ...
                    "dsmURL": "./data/kmz/JALANA.kml", // Add DSM URL
                    "dtmURL": "./data/kmz/JALANA.kml", // Add DTM URL
                    // "VillageMapURL":"./data/kmz/bordi.kml",
                    "VillageMapURL":"./data/G.Village Map/Palghar/DAHANU/BORDI/BORDI.dwg",
                    "VillageMapKmlURL":"./data/kmz/bordi.kml"
                },
                "VikaAAAAA": {
                    "chainageURL": "./data/kmz/JALANA.kml",
                    "ECWURL": "./data/ecw/Palghar.gmw",
                    ...
                    "dtmURL": "./data/kmz/JALANA.kml", // Add DTM URL
                    "VillageMapURL":"./data/G.Village Map/Palghar/DAHANU/BORDI/BORDI.dwg",
                    "VillageMapKmlURL":"./data/kmz/ADHI.kml"
                },
                "vikasnagarq1":{
                    "chainageURL":"./data/kml/jalna.kml",
                    "EcwURL":"./data/kml/palghar.gmw",
                    "dsmURL":"./data/kmz/JALNA.kml",
        ...
        "thane": {
            ...
            "ratnagoti": {
                ...
                "zai":{
                    "chainageURL":"./data/kmz/JALANA.kml",
                    "ECWURL":"./data/ecw/Palghar/talasari/Zai.gmw",
                    "dtmURL":"./data/kmz/JALANA.kml",
                    "dsmURL":"./data/kmz/thorendfff.kml",
                    "villageMapURL":"./data/G.VillageMap/Palghar/Talasari/Zai/Zai.dwg",
                    "VillageMapKmlUrl":"./dataG.VillageMapKml/Palghar/Talasari/Zai/Zai.kml",
                },
                "Bordi":{
                    "chainageURL":"./data/kmz/JALANA.kml",
                    "ECWURL":"./data/ECW/Palghar/Dahanu/Bordi.gmw",
                    "dtmURL":"./data/kmz/JALANA.kml",
                    "dsmURL":"./data/kmz/thorendfff.kml",
                    "VillageMapKmlUrl":"./data/G.VillageMapKml/Palghar/Dahanu/Bordi.kml",
                    "VillageMapURL":"./data/G.VillageMap/Palghar/Dahannu/Bordi.dwg"
                },
                "Vikasnagar":{
                    "chainageURL":"./data/kmz/Jalna.kml",
                    "ECWURL":"./data/ECW/Palghar/Dahanu/Vikasnagar.gmw",
                    "dtmURL":"./data/kmz/JALNA.kml",
                    "VillageMapURL":"./data/G.VillageMap/Palghar/Dahanu/Vikasnagar.dwg",
                    "VillageMapKmlURL":"./data/G.VillageMapKml/palghar/Dahanu/Vikasnagar.kml",
                    "dsmURL":"./data/kmz/thorendfff.kml"
                },
                "chandigaon":{
                    "chainageURL":"./data/kmz/Jalana.kml",
                    "ECWURL":"./data/ecw/Palghar/Dahanu/Chandigaon.gmw",
                    "dtmURL":"./data/kmz/JALANA.kml",
                    "dsmURL":"./data/kmz/thorendfff.kml",
                    "VillageMapURL":"./data/G.VillageMap/Palghar/Dahanu/Chandigaon.dwg",
                    "VillageMapKmlURL":"./data/G.VillageMapKml/Palghar/Dahanu/Chandigaon.kml",
                },
                "Aambewadi":{
                    "chainageURL":"./data/kmz/Jalana.kml",
                    "ECWURL":"./data/ecw/Palghar/Dahanu/Aambewadi.gmw",
                    "VillageMapURL":"./data/G.VillageMap/Palghar/Dahanu/Aambewadi.dwg",
                    "VillageMapKmlURL":"./data/G.villageMapKmlURL/palghar/Dahanu/Aambewadi.kml",
                    "dtmURL":"./data/kmz/JALANA.kml",
                    "dsmURL":'./data/kmz/thorendfff.kml'
                },
                "BadePokhran":{
                    "ChainageURL":"./data/kmz/JALANA.kml",
                    "ECWURL":"./data/ecw/Palghar/Dahanu/BadePokhran.gmw",
                    "VillageMapURL":"./data/G.VillageMap/Palghar/Dahanu/BadePokhran.dwg",
                    "VillageMapKmlURL":"./data/G.VillageMapKml/Palghar/Dahanu/BadePokhran.kml",
                    "dtmURL":"./data/kmz/JALANA.kml",
                    "dsmURL":"./data/kmz/thorendfff.kml"
                },
                "chikhali":{
                    "chainageURL":"./data/kmz/JALANA.kml",
                    "ECWURL":"./data/ecw/Palghar/Dahanu/Chikhali.gmw",
                    "dsmURL":"./data/kmz/JALANA.kml",
                    "dtmURL":"./data/kmz/thorendfff.kml",
                    "VillageMapURL":"./data/G.VillageMap/palghar/Dahanu/Chikhali.dwg",
                    "VillageMapKmlURL":"./data/G.VillageMapKML/Palghar/Dahanu/BadePokhran.dwg",
                },
                "Chinchan":{
                    "chainageURL":"./data/kml/JALANA.kml",
                    "ECWURL":"./data/ecw/Palghar/Dahanu/Chinchan.gmw",
                    "dsmURL":"./data/kmz/JALANA.kml",
                    "dtmURL":"./data/kmz/thorendfff.kml",
                    "VillageMapURL":"./data/G.villageMap/Palghar/dahanu/Chinchan.dwg",
                    "VillageMapKmlUrl":"./data/G.VillageMapKml/palghar/dahanu/Chinchan.kml",
                    "ContourURL":"",
                    "APCURL":" ",
                    "NPCURL":" ",
                    "UPCURL":" ",
                ...
                "Dahanu":{
                    "chainageURL":"./data/kml/JALANA.kml",
                    "ECWURL":"./data/ecw/palghar/dahanu/dahanu.gmw",
                    "dsmURL":"./data/kmz/Jalana.kml",
                    "dtmURL":"./data/kmz/thorendfff.kml",
                    "villageMapURL":"./data/G.VillageMap/Palghar/dahanu/dahanu.dwg",
                    "VillageMapKmlURL":"./data/G.VillageMapKml/palghar/dahanu/dahanu.kml",
                    "ContourURL":"",
                    "APCURL":"",
                    "NPCURL":"",
                    "UPCURL":"",
          ...
          polylineMeasure.seed([line1coords, line2coords]);
            ...
            showButton.addEventListener('click', function (event) {
                ...
                if (selectedDistrict && selectedTaluka && selectedVillage && villageData) {
                    ...
                    const VurnableCoastlineCheckbox = document.querySelector('input[name="checkbox11"]:checked');
                    ...
                    if (chainageCheckbox && villageData['chainageURL']) {
                        ...
                        addKMLLayer(UPCURL);
                    } else if (VurnableCoastlineCheckbox && villageData['VrunableCoastlineURL']) {
